...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OutputToConsole loadedOutputToConsole = new OutputToConsole(0);

        /*if (outputToConsole.equals(loadedOutputToConsole)) System.out.println("Class was loaded correctly");
        else System.out.println("Class was NOT loaded correctly");*/

        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(byteArrayOutputStream.toByteArray());
        ObjectInputStream ois = new ObjectInputStream(byteArrayInputStream);
        loadedOutputToConsole.readExternal(ois);
        ois.close();

        loadedOutputToConsole.printMessage();
    }
}
