        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (compare == 0) {
                    ...
                    //compare = ((Date)stock1.get("date")).compareTo((Date)stock2.get("date"));
                    compare = date1.compareTo(date2);
                }
                if (compare == 0) {
                    Double profit1 = ((double)stock1.get("open")/(double)stock1.get("last"));
                    Double profit2 = ((double)stock2.get("open")/(double)stock2.get("last"));
                    compare = profit1.compareTo(profit2);
                }
                return compare;
            }
        });
